...
| 저장소 | 역할 | 개발 포트 |
|---|---|---|
| [egov-biz-api](https://github.com/gjh999/egov-biz-api) | REST API 백엔드 | 8082 (`/api`) |
| **egov-biz-react** (이 저장소) | React 19 프론트 | 5177 |
| [egov-biz-vue](https://github.com/gjh999/egov-biz-vue) | Vue 3 프론트 (짝) | 5178 |
...
`mvn spring-boot:run` 으로 8082 포트에 띄우세요.

개발 서버는 `/api` 요청을 `http://localhost:8082` 로 프록시합니다(`vite.config.ts`).
