...
import {
  ...
  CodeClassAdminPage,
  LoginLogPage,
  LoginPolicyAdminPage,
  MenuAdminPage,
  ProgramAdminPage,
  SysLogPage,
  UserAdminPage,
} from './pages/admin/BizAdminPages'
          ...
          <Routes>
            <Route element={<Layout />}>
              ...
              <Route path="admin">
                ...
                <Route path="users" element={admin(<UserAdminPage />)} />
                <Route path="codes" element={admin(<CodeAdminPage />)} />
                <Route path="codes/classes" element={admin(<CodeClassAdminPage />)} />
                <Route path="menus" element={admin(<MenuAdminPage />)} />
                <Route path="programs" element={admin(<ProgramAdminPage />)} />
                <Route path="absences" element={admin(<AbsenceAdminPage />)} />
                <Route path="login-policies" element={admin(<LoginPolicyAdminPage />)} />
                <Route path="logs/login" element={admin(<LoginLogPage />)} />
                <Route path="logs/system" element={admin(<SysLogPage />)} />
              </Route>
